...
k.creditText=Y("B`ow`rKR/bnl")):(l=k.updateOption("creditText"),v=k.updateOption("creditHref"));if(k.creditHref&&k.creditText){k._creditLink}}}function ta(k,l){Ha&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
